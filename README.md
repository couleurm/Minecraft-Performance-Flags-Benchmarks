...
Large Pages
======
**NOTE: Large Pages requires admin priviledges on Windows. This is a security risk, and you should skip this section if you aren't comfortable with that.**
...
Only GraalVM Enterprise Edition comes with the full set of optimizations. Download it from Oracle's website: https://www.oracle.com/downloads/graalvm-downloads.html

(Some select GraalVM EE versions may be available on the [AUR](https://aur.archlinux.org/packages?K=graalvm-ee) and on Oracle Linux's repos)
